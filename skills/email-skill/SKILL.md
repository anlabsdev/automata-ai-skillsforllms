# Skill: Email Skill
> @skillsforllms/email-skill - v1.0.0 - Category: Communications

## Purpose
Guide an AI agent to add transactional email templates, providers, environment config, previews, and delivery-safe patterns.

## When to Use This Skill
- A user asks to add transactional email with resend or nodemailer.
