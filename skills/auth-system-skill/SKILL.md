# Skill: Auth System Skill
> @skillsforllms/auth-system-skill - v1.0.0 - Category: Security

## Purpose
Guide an AI agent to implement production-minded authentication with JWT, OAuth, session handling, and role-based access control.

## When to Use This Skill
- A user asks to add jwt, oauth, sessions, and role-based access.
