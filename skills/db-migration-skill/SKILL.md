# Skill: DB Migration Skill
> @skillsforllms/db-migration-skill - v1.0.0 - Category: Backend

## Purpose
Guide an AI agent to plan, write, review, and verify database migrations with rollback and data-safety notes.

## When to Use This Skill
- A user asks to add safe migration scripts for postgres and mysql.
