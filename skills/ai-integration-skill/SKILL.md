...
> @skillsforllms/ai-integration-skill - v1.0.0 - Category: Ai

## Purpose
Guide an AI agent to add model calls, streaming, structured output, embeddings, RAG, and provider-safe configuration.

## When to Use This Skill
- A user asks to add add claude, openai, rag, and agent flows to existing apps.
