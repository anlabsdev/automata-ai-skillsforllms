# Skill: Testing Skill
> @skillsforllms/testing-skill - v1.0.0 - Category: Quality

## Purpose
Guide an AI agent to add focused unit, integration, and browser tests for risky behavior.

## When to Use This Skill
- A user asks to add generate jest, vitest, and playwright tests.
