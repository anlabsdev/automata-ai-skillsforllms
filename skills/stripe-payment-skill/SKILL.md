# Skill: Stripe Payment Skill
> @skillsforllms/stripe-payment-skill - v1.0.0 - Category: Payments

## Purpose
Guide an AI agent to implement Stripe checkout, subscriptions, webhook verification, customer records, and billing UI.

## When to Use This Skill
- A user asks to add checkout, webhooks, subscriptions, and billing state.
