# Skill: Deploy Skill
> @skillsforllms/deploy-skill - v1.0.0 - Category: Devops

## Purpose
Guide an AI agent to prepare applications for repeatable deployment with environment checks, CI, and platform config.

## When to Use This Skill
- A user asks to add dockerfile, github actions, vercel, and railway config.
