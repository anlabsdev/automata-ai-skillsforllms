...
> @skillsforllms/api-builder-skill - v1.0.0 - Category: Backend

## Purpose
Guide an AI agent to design and implement typed REST or tRPC APIs with validation, auth boundaries, docs, and tests.

## When to Use This Skill
- A user asks to add rest and trpc endpoint generation.
