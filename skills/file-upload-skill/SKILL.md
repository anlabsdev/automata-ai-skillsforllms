# Skill: File Upload Skill
> @skillsforllms/file-upload-skill - v1.0.0 - Category: Storage

## Purpose
Guide an AI agent to implement secure file uploads, validation, storage adapters, public/private access, and CDN-ready URLs.

## When to Use This Skill
- A user asks to add image and file upload with storage and cdn config.
