# Skill: SEO Skill
> @skillsforllms/seo-skill - v1.0.0 - Category: Marketing

## Purpose
Guide an AI agent to improve technical SEO, social previews, sitemap generation, robots config, and structured data.

## When to Use This Skill
- A user asks to add meta tags, sitemap, open graph images, and structured data.
